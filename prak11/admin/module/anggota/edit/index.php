<head>
    ...
    <style>
        .flex-footer {
            ...
            bottom: 0;
            width: 100%;
            background-color: #0D6EFD; /* Ganti dengan warna latar belakang yang diinginkan */
            text-align: center;
            padding: 5px 0; /* Sesuaikan padding atas dan bawah */
        }

        .flex-footer b {
            color: whitesmoke; /* Ganti dengan kode warna yang diinginkan, misalnya #ff0000 untuk merah */
        }
    </style>
</head>
...
<div class="flex-footer">
        &copy; 2024. <b>Ritech.id</b> all rights reserved
    </div>